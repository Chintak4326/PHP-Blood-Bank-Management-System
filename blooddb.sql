...
--
-- Host: localhost
-- Generation Time: Feb 29, 2020 at 04:28 PM
...
-- Database: `blooddb`
--
CREATE DATABASE `blooddb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `blooddb`;
...
INSERT INTO `admin` (`id`, `username`, `password`, `email`, `gender`, `dob`, `contact_no`, `Address`, `verification_key`, `active`, `forgot_status`, `otp`) VALUES
(49, 'chintak', 'chintak@43', 'chintakd999@gmail.com', 'Male', '1999-02-20', 9429004848, 'Krishnanagar,Ahmedabad', '', 0, 0, 0),
(50, 'yash', 'yash@123', 'yashparamar124@gmail.com', 'Male', '1998-12-27', 7048640464, 'Shahpur,Ahmedabad', '', 0, 0, 0),
(51, 'Manthan', 'man@123', 'modimanthan261@gmail.com', 'Male', '1998-09-18', 8000881434, 'Delhi Darwaja,Ahmedabad', '', 0, 0, 0),
(52, 'chintu', '750', 'chintak@mailnator.com', 'Male', '2019-11-30', 9429004848, 'Krishnanagar,Ahmedabad', '', 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `bloodgroup` (
  `blood_grp_id` int(11) NOT NULL AUTO_INCREMENT,
  `blood_grp_name` varchar(25) NOT NULL,
  PRIMARY KEY (`blood_grp_id`)
...
INSERT INTO `bloodgroup` (`blood_grp_id`, `blood_grp_name`) VALUES
(78, 'A-'),
(81, 'A+'),
(82, 'AB-'),
(84, 'B-'),
...
CREATE TABLE IF NOT EXISTS `city` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5916 ;
...
INSERT INTO `contactus` (`contact_id`, `fname`, `lname`, `email_id`, `mobile_no`, `city`, `message`, `answer`) VALUES
(9, 'yash', 'parmar', 'yashparmar111@gmail.com', 7048640415, 'Ahmedabad', 'Hello I Need a O+ blood for my son', ''),
(10, 'APPLE', 'GHOSH', 'manthan261@gmail.com', 9429004848, 'TARAKESWAR', 'hjkhk', '');
...
INSERT INTO `donor` (`id`, `username`, `password`, `email`, `dob`, `gender`, `blood_grp`, `weight`, `last_don_date`, `country_name`, `state_name`, `city_name`, `mobile_no`, `pincode`, `address`) VALUES
(6, 'chintak', 'chintak@43', 'chintakd999@gmail.com', '1999-02-20', 'Male', 94, '70', '2016-01-28', '101', '12', '783', 9429008484, 382345, 'Krishnanagar,Ahmedabad'),
(7, 'vatsal', 'vatsal@12', 'vatsal29011996@gmail.com', '1996-01-29', 'Male', 90, '57', '2018-02-20', '101', '10', '707', 8732997601, 470002, 'Khaugali,Delhi'),
(8, 'Manthan', 'manthan@12', 'modimanthan261@gmail.com', '1998-09-18', 'Male', 88, '80', '2015-08-15', '101', '5', '465', 8000881434, 380001, 'Shahpur,Ahmedabad'),
(9, 'yash', 'yash@123', 'yashparamar124@gmail.com', '1998-09-10', 'Male', 85, '57', '2016-05-27', '101', '6', '594', 7041568176, 382671, 'Chandigarh'),
(10, 'Avadhi', 'avadhi42', 'avadhi123@gmail.com', '1996-08-01', 'Female', 84, '57', '1998-08-10', '101', '19', '1847', 8200566360, 852016, 'Kerala'),
(11, 'milan', '5678', 'milan56@gmail.com', '1999-08-08', 'Male', 81, '65', '2018-03-22', '101', '12', '791', 7890564434, 380006, 'kalupur bhahar'),
(12, 'kamesh', '23456', 'kamesh23@gmail.com', '1997-05-18', 'Male', 78, '70', '2019-11-23', '101', '12', '788', 9723456780, 380005, 'bapunagar bahar'),
(13, 'geeta', '7890', 'geeta43@gmail.com', '1996-10-29', 'Female', 81, '61', '2018-05-08', '101', '11', '717', 9879907834, 380007, 'asarwa darwaja bahar'),
(14, 'vatsal', '456', 'manthan261@gmail.com', '2018-11-28', 'Male', 84, '70', '2018-10-30', '101', '4', '318', 9054616420, 382345, 'Ahmedabad');
...
--
-- Table structure for table `instablood`
--

CREATE TABLE IF NOT EXISTS `instablood` (
  `instablood_id` int(20) NOT NULL AUTO_INCREMENT,
  `instablood_name` varchar(50) NOT NULL,
  `instablood_number` bigint(14) NOT NULL,
  `instablood_email` varchar(2000) NOT NULL,
  PRIMARY KEY (`instablood_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `instablood`
--

INSERT INTO `instablood` (`instablood_id`, `instablood_name`, `instablood_number`, `instablood_email`) VALUES
(1, 'Insta Blood', 9429004848, ' onlineblooddonate@gmail.com');
...
CREATE TABLE IF NOT EXISTS `request` (
  ...
  `blood_grp_name` varchar(10) NOT NULL,
  `contact_no` bigint(10) NOT NULL,
  `city_name` varchar(30) NOT NULL,
  `state_name` varchar(30) NOT NULL,
  `district_name` varchar(30) NOT NULL,
  `tehsil_name` varchar(30) NOT NULL,
  `blood_req_date` date NOT NULL,
  `doctor_name` varchar(30) NOT NULL,
  `hospital_details` varchar(250) NOT NULL,
...
INSERT INTO `request` (`request_id`, `patient_name`, `contact_name`, `contact_email_id`, `blood_grp_name`, `contact_no`, `city_name`, `state_name`, `district_name`, `tehsil_name`, `blood_req_date`, `doctor_name`, `hospital_details`, `message`) VALUES
(1, 'Khushbu Dabhi', 'Darshak Doshi', 'khushbu123@gmail.com', '82', 9898745612, 'AHMEDABAD', 'ahmedabad', 'AHMEDABAD', 'AHMEDABAD', '2020-01-14', 'Dr.Raman Patel', '12,City Hospital,Kalupur', 'i want AB- blood immediately.'),
(2, 'APPLE GHOSH', 'APPLE', 'chintakdoshii4326@gmail.com', '78', 9429004848, 'TARAKESWAR', 'TARAKESWAR', 'sabarkantha', 'idar', '2019-01-30', 'darshak doshi', 'hbjh', 'bhjbj'),
(3, 'Rakesh shah', 'Naman Patel', 'rakesh123@gmail.com', '84', 8541526378, 'Ahmedabad', 'Gujarat', 'sabarkantha', 'idar', '2020-01-15', 'Dr.Yash Shah', '1,Murti Hospital,,dar', 'i want B -blood immediately.'),
(4, 'APPLE GHOSH', 'APPLE', 'chintakdoshii4326@gmail.com', 'Select Blo', 9429004848, 'TARAKESWAR', 'TARAKESWAR', 'bhjb', 'hjbhj', '2018-11-30', 'Dr.Raman Patel', 'jfnd', 'bjjk');
